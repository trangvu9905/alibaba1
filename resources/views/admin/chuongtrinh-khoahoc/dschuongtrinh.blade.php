                        ...
                        <table class="table b-t b-light" id="chuongtrinh1">
                            ...
                            <tbody>
                               ...
                               <tr>
                                  ...
                                  <td class="text-center"><img src="{{url('')}}/upload/{{$ct->logo}}" alt="" width="120px"></td>
                                   ...
                                   <td class="text-center">
                                       ...
                                       <a href="{{ route('ajax_xoachuongtrinh',$ct->id) }}" class="btn btn-default btn-sm js-xoachuongtrinh"><i class="fa fa-times "></i> Xóa</a>
                                   </td>
                                   <td class="text-center">
                                       <a onclick="event.preventDefault();hienthikhoahoc({{$ct->id}})" href="" class="btn btn-default btn-sm "><i class="fa fa-plus-circle"></i> Danh sách khóa học</a>
                                   </td>
                               </tr>
                               @endforeach
                               @endif
              ...
              @foreach($chinhanh as $cn)    
                <tr>
                  ...
                  <td class="text-center"><label class="radio i-checks cursor_hand"> 
                   <input value="{{$cn->id}}" name="chinhanh[]" id="cn_{{$cn->id}}" type="checkbox"><i></i> 
                 </label>
               </td> 
                </tr>  
                @endforeach  
            ...
            <div class="modal-content">
              ...
              @foreach($chinhanh as $cn)    
                <tr>
                  <td>{{$cn->ten}}</td> 
                  <td class="text-center"><label class="radio i-checks cursor_hand"> 
                   <input value="{{$cn->id}}" name="chinhanh[]" id="cn" type="checkbox"><i></i> 
                 </label>
               </td> 
                </tr>  
                @endforeach  
...
<script type="text/javascript">
  ...
  // thêm chương trình
    $(function () {
        ...
        let URL = '{{ route('ajax_post.themchuongtrinh') }}';
...
function editchuongtrinh(ct) {
    ...
    $.ajax({
        ...
        $("#form-suachuongtrinh #img_cu").attr('src','{{url("")}}/upload/'+data.ct.logo);
...
// hiển thị khóa học
 ...
 $(function () {
        ...
        let URL = '{{ route('ajax_post.themkhoahoc') }}'
...
$('body').on("click",'.js-xoakhoahoc',function(event){
  ...
  function editkhoahoc(kh) {
    ...
    $.ajax({
        ...
        //$("#form-suakhoahoc #img_cu").attr('src','{{url("")}}/upload/'+data.ct.logo);
