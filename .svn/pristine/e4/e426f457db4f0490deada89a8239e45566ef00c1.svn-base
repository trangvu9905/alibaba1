            ...
            <div class="menu-option-top1 panel b-a m-b-sm">
                <div class="row m-n">
                    ...
                    <div id="menutop_search" class="item-menu col-md-2 b-r m-t-xs m-b-xs">
                        <a href="hoc-vien/dshocvien" class="block hover">
                            <span class="i-s i-s-1-5x pull-left m-r-xs">
                    ...
                    <div id="menutop_tiemnang" class="item-menu col-md-2 b-r m-t-xs m-b-xs item-active">
                        <a href="hoc-vien/dshocvientiemnang" class="block hover">
                            <span class="i-s i-s-1-5x pull-left m-r-xs">
